...
class Act:
    ...
    def controll(self):
        ...
        if c == "voiceout":
            ...
            text_to_speech("I don't understand")
...
def openImageClassifier():
    ...
    try:
        command = r.recognize_sphinx(audio, keyword_entries=[('lumio', 1), ('hey', 1)])
        text_to_speech("What can I do for you?")
    except sr.UnknownValueError:
        text_to_speech("Could not understand audio")
    except sr.RequestError as e:
        text_to_speech("Error; {0}".format(e))

    recognizer = sr.Recognizer()

    try:
        with sr.Microphone() as source:
            text_to_speech("Tell me more")
